...
export function PregnancyCalculator() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Pregnancy Due Date Calculator</h1>
        <p className="text-gray-600">Calculate your pregnancy due date and timeline</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="md:col-span-2">
          ...
          <div className="mt-6">
            <AdPlaceholder label="Pregnancy Calculator Ad" />
          </div>
        </div>
